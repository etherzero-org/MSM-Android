...
import com.msmwallet.presenter.activities.util.BRActivity;
import com.msmwallet.presenter.customviews.BRButton;
import com.msmwallet.presenter.customviews.BRSearchBar;
...
import com.msmwallet.tools.manager.FontManager;
import com.msmwallet.tools.manager.InternetManager;
import com.msmwallet.tools.manager.TxManager;
import com.msmwallet.tools.services.SyncService;
...
import com.msmwallet.tools.util.SyncTestLogger;
...
import com.msmwallet.wallet.util.CryptoUriParser;
import com.msmwallet.wallet.util.HttpUtils;
import com.msmwallet.wallet.wallets.CryptoAddress;
import com.msmwallet.wallet.wallets.bitcoin.BaseBitcoinWalletManager;
...
public class WalletActivity extends BRActivity implements InternetManager.ConnectionReceiverListener,
    ...
    public static final String EXTRA_URL = "com.msmwallet.EXTRA_URL";
